...
function Profile() {
  return (
    <div className="mt-4 md:mt-12 h-full flex items-center flex-col  ">
      ...
      <form action="" className="mt-8 grid grid-cols-2 gap-y-6 gap-x-12 mb-8">
        <div className="flex flex-col gap-6 justify-self-center">
          <div className="flex flex-col items-start gap-2">
            <label htmlFor="email">E-mail</label>
            <InputElement disabled={true} value="kaanpmete@gmail.com" />
          </div>
          <div className="flex flex-col items-start  gap-2">
            <label htmlFor="password">Password</label>
            <InputElement type="password" value="123456" />
          </div>
          <div className="flex flex-col items-start  gap-2">
          ...
          <div className="flex flex-col items-start  gap-2">
            ...
            <InputElement value="Kaan" />
          </div>
          <div className="flex flex-col items-start  gap-2">
            <label htmlFor="lastname">Last name</label>
            <InputElement value="Peksen" />
          </div>
        </div>
